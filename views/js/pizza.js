...
var listOfAdjectives = ["dark", "color", "whimsical", "shiny", "noise", "apocalyptic", "insulting", "praise", "scientific"];  // types of adjectives for pizza titles
...
function generator(adj, noun) {
  ...
  var randomAdjective = parseInt(Math.random() * listOfAdjectives.length);
  var randomNoun = parseInt(Math.random() * nouns.length);
  var name = "The " + listOfAdjectives[randomAdjective].capitalize() + " " + nouns[randomNoun].capitalize();
  return name;
}

// Chooses random adjective and random noun
function randomName() {
  var randomNumberAdj = parseInt(Math.random() * listOfAdjectives.length);
  var randomNumberNoun = parseInt(Math.random() * nouns.length);
  return generator(listOfAdjectives[randomNumberAdj], nouns[randomNumberNoun]);
}
